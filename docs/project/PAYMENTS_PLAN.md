...
This document is the canonical task brief for production donation work. It aligns with `docs/team/tasks/MIKHAIL_TASKS.md` for ownership and task tracking.
